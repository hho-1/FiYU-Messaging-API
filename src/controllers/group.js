...
module.exports = {
    ...
    list: async (req, res) => {
        ...
        */
        ...
        const data = await res.getModelList(Group)
    ...
    read: async (req, res) => {
        /*
            #swagger.tags = ["Categories"]
            #swagger.summary = "Get Single Group"
        */
    ...
    update: async (req, res) => {
        ...
        */
        ...
        const data = await Group.updateOne({ _id: req.params.id }, req.body, { runValidators: true })

        res.status(202).send({
            error: false,
            data,
            new: await Group.findOne({ _id: req.params.id })
        })
    },
    ...
    delete: async (req, res) => {
        ...
        */
        ...
        const data = await Group.deleteOne({ _id: req.params.id })
